<#Скрипт содержит форму создания пользователя в AD. Создание почтового ящика. Присвоение группы по умолчанию и создание пользовательской папки на сетевом диске.
Создание логина происходит путем транслитериции фамилии, если такой логин существует, то ему добавляется первая буква имени, если и такой есть, то первая буква отчества.
#>
